...
@Component({
  selector: "app-agregar-material-salida",
  templateUrl: "./agregar-material-salida.component.html",
  styleUrls: ["./agregar-material-salida.component.scss"],
  providers: [
    DatePipe,
...
export class AgregarMaterialSalidaComponent implements OnInit {
  ...
  getMateriales(subcategoria, clase, almacen) {
    ...
    clase = clase ? clase : 0;
    this.nota_almacen_s
      .GetMateriales(0, subcategoria, clase, almacen)
      .subscribe(
        (data: any) => {
          this.searchBan = false;
  ...
  save() {
    ...
    if (rep) {
      ...
      this.material.material = this.material.nombreMaterial;
      this.material.cantidad = this.cantidad;
      this.material.cantidadTotal = this.cantidad;
      this.material.observacion = this.controlsDatos.Observacion.value;
      this.material.cantDespachada = 0.00;
      this.material.cantxDespachar = this.cantidad;
