...
@Component({
  selector: "app-copy-documento-compra",
  templateUrl: "./copy-documento-compra.component.html",
  styleUrls: ["./copy-documento-compra.component.scss"],
  providers: [
    DatePipe,
...
export class CopyDocumentoCompraComponent implements OnInit {
  /* Datos Generales */
    ...
    this.documento_compra_s.SaveUpdateDocumentoCompra(datos).subscribe(
      (data: any) => {
        ...
        if (data[0].Ok > 0) {
          ...
          this.router.navigate(["Logistica/masters/DocumentoCompra"]);
        } else {
          this.hide_load_guardar = true;
          this.hide_load_cerrar = true;
    ...
    this.documento_compra_s
      ...
      .subscribe(
        (data: any) => {
          ...
          this.getOrdenCompra(generales.idProveedor, generales.idOrdenCompra);
          this.getTipoDocumentos(generales.idTipoDocumento);
          this.getFormaPago(generales.idFormaPago);
          this.getTipoMoneda(generales.idMoneda);
          this.controlsDatos.TasaCambio.setValue(generales.tasaCambio);
          this.controlsDatos.FechaEmision.setValue(
          ...
          this.getEstablecimientos(generales.idEstablecimiento);
