...
@Component({
  selector: "app-edit-documento-compra",
  templateUrl: "./edit-documento-compra.component.html",
  styleUrls: ["./edit-documento-compra.component.scss"],
  providers: [
    DatePipe,
...
export class EditDocumentoCompraComponent implements OnInit {
  /* Datos Generales */
  ...
  sumarMontos() {
    ...
    console.log(sumaTotal, totalDet);
  }
    ...
    this.documento_compra_s
      ...
      .subscribe(
        (data: any) => {
          ...
          if (this.estadoDC != "0001") {
            this.array_ultimas_compras.forEach((element) => {
              if (
                element.anticipo == 1 &&
                (element.idOrdenCompra ==
                  this.controlsDatos.OrdenCompra.value ||
