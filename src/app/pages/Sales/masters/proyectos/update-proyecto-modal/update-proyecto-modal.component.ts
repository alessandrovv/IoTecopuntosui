...
@Component({
  selector: 'app-update-proyecto-modal',
  templateUrl: './update-proyecto-modal.component.html',
  styleUrls: ['./update-proyecto-modal.component.scss']
})
export class UpdateProyectoModalComponent implements OnInit {
  ...
  getCliente(){
    this.proyecto_s.GetCliProyecto().subscribe(
      (data: any) => {
        this.array_cliente = data;
        console.log(this.array_cliente);              
      }, (errorServicio) => { 
